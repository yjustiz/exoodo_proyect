...
class Paciente(models.Model):
    ...
    #Datos del sexo
    sexo = fields.Selection(string='Sexo', selection=[('masculino', 'Masculino'), 
                        ('femenino', 'Femenino')])
    color_piel = fields.Selection(string='Color Piel', selection=[('blanca', 'Blanca'), 
                                ('negra', 'Negra'), ('amarilla', 'Amarilla'), ('mestiza', 'Mestiza')])
    edad_actual = fields.Char(string = 'Edad', size = 3, required= True) #validar este campo
    ...
    provincia = fields.Selection(string = 'Provincia', selection=[('guantanamo', 'Guantanamo'), ('santiago de cuba', 'Santiago de Cuba'),
                        ...
                        ('pinar del rio', 'Pinar del Rio'), ('la habana', 'La habana')]) 
