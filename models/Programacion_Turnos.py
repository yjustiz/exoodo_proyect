...
#Datos para reservar turno
    ...
    dia_de_semana = fields.Selection(string='Día del Turno', selection=[('lunes', 'Lunes'),
                                ('martes', 'Martes'), ('miércoles', 'Miércoles'), ('jueves', 'Jueves'), ('viernes', 'Viernes')], default='lunes') 
    mes_del_turno = fields.Selection(string='Mes del Turno', selection=[('1', 'Enero'), 
...
#-----------------------------------------------------------------------#
    ...
    #Este registro se oculto el boton hasta definir como utilizarlo
...
class DatosRegistroTurno(models.Model):
    ...
    nombre_apellidos_id = fields.Many2one(comodel_name = 'cad.paciente',string = 'Nombre del Paciente')
     ...
     #hoja de ingreso
    remitido = fields.Selection(string = 'Remitido', selection=[('area salud','Area Salud'), 
                            ('endocrino','Endocrino'), ('otros centros','Otros Centros')], help = 'Por quien fue remitido')
    area_salud = fields.Selection(string = 'Area de salud', selection=[('julian grimau', 'Julian Grimau'), ('carlos j. finlay', 'Carlos J. Finlay'), ('distrito josé martí', 'Distrito José Martí'), 
    ...
    ocupacion = fields.Selection(string = 'Ocupacion', selection=[('ama de casa', 'Ama de Casa'), 
                        ('trabajador', 'Trabajador'),('jubilado', 'Jubilado'), ('estudiante', 'Estudiante'), 
                        ('s/ocupación', 'S/Ocupación'), ('cuentapropista', 'Cuentapropista')])
    ...
    municipio = fields.Selection(related='nombre_apellidos_id.municipio')
